...
scores = scores + score_contrainte1(generation_edt); %poids faible (0-5)
scores = scores + score_contrainte2(generation_edt); %poids faible (0-5)
scores = scores + score_contrainte3(generation_edt); %poids moyen (10-15)
scores = scores + score_contrainte4(generation_edt); %poids moyen (15-20)
scores = scores + score_contrainte5(generation_edt); %poids moyen (15-20)
